                        ...
                        <form method='POST' action='{{ route('clientes.store') }}'>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" class="form-control border border-2 p-2" id="telefone2" placeholder="Telefone 2" name="telefone2">
                                    @error('telefone2')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" class="form-control border border-2 p-2" id="telefone3" placeholder="Telefone 3" name="telefone3">
                                    @error('telefone3')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
