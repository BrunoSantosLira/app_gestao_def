                                ...
                                <table class="table align-items-center justify-content-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><input class="form-control" type="text" name="nome" value="{{$categoria['categoria']}}"></p>
                                                </td>
                                                </td>
                                                <td class="float-end">
                                                @if (auth()->user()->email == 'admin@material.com')
                                                        <form method="POST" class="d-inline-block" action="{{route('categorias.destroy', ['categoria' => $categoria->id])}}">
                                                            @csrf
                                                            @method('DELETE')
                ...
                <div class="modal-body">
                    <form action="{{route('categorias.store')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border border-2 p-2 mb-2" id="categoria" placeholder="categoria" name="categoria">
