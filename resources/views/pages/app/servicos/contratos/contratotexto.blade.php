Pelo presente instrumento particular de um lado <span class="text-bold">{{$contrato['cliente']['nome']}}</span>,
brasileira, divorciada, portadora do CPF nº <span class="text-bold">{{$contrato['cliente']['CPF/CNPJ']}}</span>, e inscrita no
SSP/DF, nº ##ClienteRG##, domiciliado no <span class="text-bold">{{$contrato['cliente']['logradouro']}}</span>,
<span class="text-bold">{{$contrato['cliente']['logradouroNumero']}}</span>, <span class="text-bold">{{$contrato['cliente']['complemento']}}</span>, <span class="text-bold">{{$contrato['cliente']['bairro']}}</span>,
<span class="text-bold">{{$contrato['cliente']['cidade']}}</span>, <span class="text-bold">{{$contrato['cliente']['UF']}}</span>, <span class="text-bold">{{$contrato['cliente']['CEP']}}</span>,
telefone: <span class="text-bold">{{$contrato['cliente']['telefone']}}</span>, doravante denominada CONTRATANTE e, de
...
aquecedores para o imóvel situado no domiciliado no <span class="text-bold">{{$contrato['cliente']['logradouro']}}</span>,
<span class="text-bold">{{$contrato['cliente']['logradouroNumero']}}</span>, <span class="text-bold">{{$contrato['cliente']['complemento']}}</span>,
<span class="text-bold">{{$contrato['cliente']['bairro']}}</span>, <span class="text-bold">{{$contrato['cliente']['cidade']}}</span>,<span class="text-bold">{{$contrato['cliente']['UF']}}</span>, <span class="text-bold">{{$contrato['cliente']['CEP']}}</span>,.
<br>
...
<p>
    ...
    <p>
        Taguatinga, {{ \Carbon\Carbon::now()->format('d/m/Y') }}
    </p>
</p>
