            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        <form method='POST' action='{{ route('ContasPagas.update', ['ContasPaga' => $conta->id]) }}'>
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select id="status_pagamento" class="form-select p-2" name="status_pagamento">
                                        <option class="" value="{{$conta['status_pagamento']}}">STATUS ATUAL: ({{$conta['status_pagamento']}})</option>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text"  name="metodo_pagamento"  class="form-control border border-2 p-2" value='{{$conta->metodo_pagamento}}' id="metodo_pagamento" placeholder="Insira a forma de pagamento">
