                    ...
                    <div class="card-header pb-0 p-3">
                        ...
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-3">Inserção de Contas a Pagar</h6>
                            </div>
                        ...
                        <form method='POST' action='{{ route('ContasPagas.store') }}'>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date"  name="data_vencimento" required class="form-control border border-2 p-2" value='' id="nome" placeholder="Insira o nome da conta">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date"  name="data_pagamento" disabled class="form-control border border-2 p-2" value='' id="nome" placeholder="Insira o nome da conta">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text"  name="metodo_pagamento"  class="form-control border border-2 p-2" value='' id="metodo_pagamento" placeholder="Insira a forma de pagamento">
