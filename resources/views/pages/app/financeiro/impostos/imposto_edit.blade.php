            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    <div class="card-header pb-0 p-3">
                        ...
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-3">Editar Imposto</h6>
                            </div>
                    ...
                    <div class="card-body p-3">
                        <form method='POST' action='{{ route('impostos.update', ['imposto' => $imposto->id]) }}'>
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="produto_id" id="" class="form-control border border-2 p-2">
                                        <option value="{{$imposto->produto_id}}">{{$imposto->produto_id}}</option>
                                        @foreach ($produtos as $produto)
                                            <option value="{{$produto->id}}">{{$produto->produto}} - ({{$produto->id}})</option>
                                        @endforeach
                                    </select>
                                </div>
